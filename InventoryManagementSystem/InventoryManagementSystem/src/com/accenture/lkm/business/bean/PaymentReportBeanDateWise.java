...
public class PaymentReportBeanDateWise {
	...
	public PaymentReportBeanDateWise() {
		super();
	}

	public PaymentReportBeanDateWise(Integer paidId, String paidType, String chequeNo, String remarks, Double paidAmount, Double balance, Date paidDate, PurchaseEntity purchaseEntity) {
		super();
